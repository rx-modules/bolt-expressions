...
execute store result storage bolt.expr:temp 2384k242hd495_3 double 0.01 run scoreboard players get $x obj
...
execute store result storage demo num double 0.01 run data get storage bolt.expr:temp 2384k242hd495_25 1
execute store result storage bolt.expr:temp 2384k242hd495_31 short 1 run scoreboard players get $val obj
execute store result storage demo a int 100 run data get storage bolt.expr:temp 2384k242hd495_31 1
execute store result storage demo a double 0.1 run data get storage bolt.expr:temp 2384k242hd495_31 1
...
execute store result storage demo a double 0.1 run data get storage bolt.expr:temp 2384k242hd495_43 1
say nicer
execute store result storage bolt.expr:temp 2384k242hd495_50 double 0.01 run scoreboard players get $foo obj
...
execute store result storage bolt.expr:temp 2384k242hd495_58 int 0.1 run data get storage demo c 1
