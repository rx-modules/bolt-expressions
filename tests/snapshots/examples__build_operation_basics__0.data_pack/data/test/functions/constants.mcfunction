...
scoreboard players operation $a abc.main = $i0 bolt.expr.temp
scoreboard players operation $a abc.main *= $-1 bolt.expr.const
scoreboard players operation $i0 bolt.expr.temp = $b abc.main
scoreboard players operation $b abc.main = $i0 bolt.expr.temp
