...
say <class 'nbtlib.tag.String'>
say nbtlib.tag.String | None
say nbtlib.tag.String | nbtlib.tag.Int | None
...
data modify storage name:path new_item set value {id: "bla", Count: 5, tag: {CustomModelData: 14.2f, Items: [{id: "stone", Count: 3}]}}
data modify storage name:path new_item merge from storage name:path other_item
data modify storage name:path new_item merge value {tag: {Items: [{Count: 23}]}}
