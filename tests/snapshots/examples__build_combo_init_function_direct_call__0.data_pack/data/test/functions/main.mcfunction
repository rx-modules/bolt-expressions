...
scoreboard players operation $i2 bolt.expr.temp = #denom abc.main
scoreboard players operation $i2 bolt.expr.temp *= $5 bolt.expr.const
scoreboard players operation @s abc.main /= $i2 bolt.expr.temp
scoreboard players operation @s abc.main = #value abc.main
