...
execute store result block 0 0 0 data.ur_mom int 40 run scoreboard players get $i0 bolt.expr.temp
execute store result score $i0 bolt.expr.temp run data get block ~1 ~2 ~3 Items[0].Count 1
execute store result block ~1 ~2 ~3 Items[0].Count double 0.02 run scoreboard players get $i0 bolt.expr.temp
