...
scoreboard players operation $f abc.main = $r abc.main
scoreboard players remove $f abc.main 1
scoreboard players operation $f abc.main > $4 bolt.expr.const
scoreboard players operation $i0 bolt.expr.temp = $q abc.main
