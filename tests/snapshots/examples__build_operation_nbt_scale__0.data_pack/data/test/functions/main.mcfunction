...
data modify storage demo out set from storage demo value
say # scaled score
...
scoreboard players operation $i0 bolt.expr.temp = $value obj
scoreboard players add $i0 bolt.expr.temp 1
execute store result storage demo out float 0.1 run scoreboard players get $i0 bolt.expr.temp
say # get scaled data
...
execute store result storage demo list[-1] float 0.01 run scoreboard players get $i1 bolt.expr.temp
